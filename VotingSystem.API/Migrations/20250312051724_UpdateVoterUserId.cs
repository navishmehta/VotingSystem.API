...
{
    /// <inheritdoc />
    public partial class UpdateVoterUserId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectionConfig", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatesWon = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NationalResults", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StateResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StateResults_Candidates_CandidateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectionConfig_Id",
                table: "ElectionConfig",
                column: "Id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StateResults_CandidateId",
                table: "StateResults",
                column: "CandidateId");
